...
// 2024-09-09 23:56:56.781086 UTC
    ...
    namespace schemas {
        ...
        namespace client_dll {
            ...
            namespace C_CSPlayerPawn {
                ...
                constexpr std::ptrdiff_t m_flFlinchStack = 0x22B8; // 
                constexpr std::ptrdiff_t m_flVelocityModifier = 0x22BC; // 
                constexpr std::ptrdiff_t m_flHitHeading = 0x22C0; // 
                constexpr std::ptrdiff_t m_nHitBodyPart = 0x22C4; // 
                constexpr std::ptrdiff_t m_bWaitForNoAttack = 0x22C8; // 
                constexpr std::ptrdiff_t m_ignoreLadderJumpTime = 0x22CC; // 
                constexpr std::ptrdiff_t m_bKilledByHeadshot = 0x22D1; // 
                constexpr std::ptrdiff_t m_ArmorValue = 0x22D4; // 
                constexpr std::ptrdiff_t m_unCurrentEquipmentValue = 0x22D8; // 
                constexpr std::ptrdiff_t m_unRoundStartEquipmentValue = 0x22DA; // 
                constexpr std::ptrdiff_t m_unFreezetimeEndEquipmentValue = 0x22DC; // 
                constexpr std::ptrdiff_t m_nLastKillerIndex = 0x22E0; // 
                constexpr std::ptrdiff_t m_bOldIsScoped = 0x22E4; // 
                constexpr std::ptrdiff_t m_bHasDeathInfo = 0x22E5; // 
                constexpr std::ptrdiff_t m_flDeathInfoTime = 0x22E8; // 
                constexpr std::ptrdiff_t m_vecDeathInfoOrigin = 0x22EC; // 
                constexpr std::ptrdiff_t m_grenadeParameterStashTime = 0x22F8; // 
                constexpr std::ptrdiff_t m_bGrenadeParametersStashed = 0x22FC; // 
                constexpr std::ptrdiff_t m_angStashedShootAngles = 0x2300; // 
                constexpr std::ptrdiff_t m_vecStashedGrenadeThrowPosition = 0x230C; // 
                constexpr std::ptrdiff_t m_vecStashedVelocity = 0x2318; // 
                constexpr std::ptrdiff_t m_angShootAngleHistory = 0x2324; // 
                constexpr std::ptrdiff_t m_vecThrowPositionHistory = 0x233C; // 
                constexpr std::ptrdiff_t m_vecVelocityHistory = 0x2354; // 
                constexpr std::ptrdiff_t m_PredictedDamageTags = 0x2370; // 
                constexpr std::ptrdiff_t m_nPrevHighestReceivedDamageTagTick = 0x23C0; // 
                constexpr std::ptrdiff_t m_nHighestAppliedDamageTagTick = 0x23C4; // 
            }
            ...
            namespace C_CSGO_PreviewPlayer {
                constexpr std::ptrdiff_t m_animgraph = 0x23C8; // 
                constexpr std::ptrdiff_t m_animgraphCharacterModeString = 0x23D0; // 
                constexpr std::ptrdiff_t m_flInitialModelScale = 0x23D8; // 
            }
            ...
            namespace C_RopeKeyframe {
                ...
                constexpr std::ptrdiff_t m_iRopeMaterialModelIndex = 0xD10; // 
                ...
                constexpr std::ptrdiff_t m_hMaterial = 0x1030; // 
            ...
            namespace C_BarnLight {
                ...
                constexpr std::ptrdiff_t m_QueuedLightStyleStrings = 0xD08; // 
                constexpr std::ptrdiff_t m_LightStyleEvents = 0xD20; // 
            ...
            namespace C_EnvDecal {
                constexpr std::ptrdiff_t m_hDecalMaterial = 0xCC8; // 
            ...
            namespace C_EnvCubemapFog {
                ...
                constexpr std::ptrdiff_t m_hSkyMaterial = 0x578; // 
            ...
            // NetworkVarNames: m_bEnabled (bool)
            namespace C_EnvSky {
                constexpr std::ptrdiff_t m_hSkyMaterial = 0xCC8; // 
                constexpr std::ptrdiff_t m_hSkyMaterialLightingOnly = 0xCD0; // 
            ...
            namespace C_Beam {
                ...
                constexpr std::ptrdiff_t m_hBaseMaterial = 0xD00; // 
                constexpr std::ptrdiff_t m_nHaloIndex = 0xD08; // 
            ...
            namespace C_PointWorldText {
                ...
                constexpr std::ptrdiff_t m_nJustifyHorizontal = 0xF34; // 
            ...
            namespace CCSPlayerController {
                ...
                constexpr std::ptrdiff_t m_pActionTrackingServices = 0x710; // 
                constexpr std::ptrdiff_t m_pDamageServices = 0x718; // 
                constexpr std::ptrdiff_t m_iPing = 0x720; // 
                constexpr std::ptrdiff_t m_bHasCommunicationAbuseMute = 0x724; // 
                constexpr std::ptrdiff_t m_szCrosshairCodes = 0x728; // 
                constexpr std::ptrdiff_t m_iPendingTeamNum = 0x730; // 
                constexpr std::ptrdiff_t m_flForceTeamTime = 0x734; // 
                constexpr std::ptrdiff_t m_iCompTeammateColor = 0x738; // 
                constexpr std::ptrdiff_t m_bEverPlayedOnTeam = 0x73C; // 
                constexpr std::ptrdiff_t m_flPreviousForceJoinTeamTime = 0x740; // 
                constexpr std::ptrdiff_t m_szClan = 0x748; // 
                constexpr std::ptrdiff_t m_sSanitizedPlayerName = 0x750; // 
                constexpr std::ptrdiff_t m_iCoachingTeam = 0x758; // 
                constexpr std::ptrdiff_t m_nPlayerDominated = 0x760; // 
                constexpr std::ptrdiff_t m_nPlayerDominatingMe = 0x768; // 
                constexpr std::ptrdiff_t m_iCompetitiveRanking = 0x770; // 
                constexpr std::ptrdiff_t m_iCompetitiveWins = 0x774; // 
                constexpr std::ptrdiff_t m_iCompetitiveRankType = 0x778; // 
                constexpr std::ptrdiff_t m_iCompetitiveRankingPredicted_Win = 0x77C; // 
                constexpr std::ptrdiff_t m_iCompetitiveRankingPredicted_Loss = 0x780; // 
                constexpr std::ptrdiff_t m_iCompetitiveRankingPredicted_Tie = 0x784; // 
                constexpr std::ptrdiff_t m_nEndMatchNextMapVote = 0x788; // 
                constexpr std::ptrdiff_t m_unActiveQuestId = 0x78C; // 
                constexpr std::ptrdiff_t m_nQuestProgressReason = 0x790; // 
                constexpr std::ptrdiff_t m_unPlayerTvControlFlags = 0x794; // 
                ...
                constexpr std::ptrdiff_t m_bCannotBeKicked = 0x7CC; // 
                constexpr std::ptrdiff_t m_bEverFullyConnected = 0x7CD; // 
                constexpr std::ptrdiff_t m_bAbandonAllowsSurrender = 0x7CE; // 
                constexpr std::ptrdiff_t m_bAbandonOffersInstantSurrender = 0x7CF; // 
                constexpr std::ptrdiff_t m_bDisconnection1MinWarningPrinted = 0x7D0; // 
                constexpr std::ptrdiff_t m_bScoreReported = 0x7D1; // 
                ...
                constexpr std::ptrdiff_t m_bPawnIsAlive = 0x7F4; // 
                constexpr std::ptrdiff_t m_iPawnHealth = 0x7F8; // 
                constexpr std::ptrdiff_t m_iPawnArmor = 0x7FC; // 
                constexpr std::ptrdiff_t m_bPawnHasDefuser = 0x800; // 
                constexpr std::ptrdiff_t m_bPawnHasHelmet = 0x801; // 
                constexpr std::ptrdiff_t m_nPawnCharacterDefIndex = 0x802; // 
                constexpr std::ptrdiff_t m_iPawnLifetimeStart = 0x804; // 
                constexpr std::ptrdiff_t m_iPawnLifetimeEnd = 0x808; // 
                constexpr std::ptrdiff_t m_iPawnBotDifficulty = 0x80C; // 
                constexpr std::ptrdiff_t m_hOriginalControllerOfCurrentPawn = 0x810; // 
                constexpr std::ptrdiff_t m_iScore = 0x814; // 
                constexpr std::ptrdiff_t m_vecKills = 0x818; // 
                constexpr std::ptrdiff_t m_bMvpNoMusic = 0x830; // 
                constexpr std::ptrdiff_t m_eMvpReason = 0x834; // 
                constexpr std::ptrdiff_t m_iMusicKitID = 0x838; // 
                constexpr std::ptrdiff_t m_iMusicKitMVPs = 0x83C; // 
            ...
            // NetworkVarNames: m_flHDRColorScale (float32)
            namespace C_Sprite {
                constexpr std::ptrdiff_t m_hSpriteMaterial = 0xCC8; // 
